<%@ Page Language="C#" AutoEventWireup="true" Inherits="Contract_LeaseCardModify" Codebehind="LeaseCardModify.aspx.cs" %>
...
function MPay()
{
    var returnV=window.showModalDialog("DefinePay.aspx?id="+$("CardID").value+"&g="+(new Date()).getTime(),"","dialogWidth=650px;dialogHeight:305px;center=yes;");
    if(returnV)
    {
...
function goback(ctype) {
    if (ctype == "0" || ctype == "1") {
        location.href = 'LeaseList.aspx?ctype=' + ctype;
    }
    else {
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t2" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">合同卡片变更</span>&nbsp;
                </td>
            </tr>
        </table>
        ...
        <table id="CardInfo" cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                ...
                <td class="t2" style="width: 35%;">
                    <asp:TextBox ID="ModifyDate" runat="server" Width="180px" BorderWidth="1px" BackColor="#F6F6F6"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="t1" style="text-align: right; height: 25px;" id="TD_Name" runat="server">
                    租赁资源：</td>
                <td class="t1">
                    <asp:TextBox ID="ResourceName" runat="server" Width="180px" BorderWidth="1px" BackColor="#F6F6F6"></asp:TextBox></td>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="4" style="height: 52px; text-align: center">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="Button2" onclick="goback('<%=Request.QueryString["ctype"] %>')" type="button" value="显示合同列表" style="width: 191px; height: 33px" /></td>
            </tr>
        </table>
    </div>
    <asp:HiddenField ID="CardID" runat="server" />
    <asp:HiddenField ID="OldCardNo" runat="server" />
    <asp:HiddenField ID="hidELease" runat="server" />
