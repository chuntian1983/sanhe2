<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountCollect_IndexMonitorShow0" Codebehind="IndexMonitorShow0.aspx.cs" %>
...
<body style="text-align:center; width:760px">
    ...
    <div style="width:750px; text-align:left">
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="color:green; font-size: 16pt;" runat="server">指标监控 —— 单笔发生额</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
        ...
        {
            document.getElementById("tabReportBottom").style.width=750;
        }
        </script>
    </div>
