<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="AccountCollect_FixedAssetQuery" Codebehind="FixedAssetQuery.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="color:green; font-size: 16pt;" runat="server">重大资产限额查询</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
