...
public partial class AccountCollect_MonitorFixedAssetChart : System.Web.UI.Page
{
    ...
    protected void CalculateSum(string accountID)
    {
        ...
        if (sumRow == null)
        {
            ...
            double temp = 0;
            double.TryParse(CommClass.GetTableValue("cw_assetcard", "sum(oldprice)", sumCondition), out temp);
            newRow["sum"] = temp;
