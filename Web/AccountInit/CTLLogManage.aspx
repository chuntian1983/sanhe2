<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountInit_CTLLogManage" Codebehind="CTLLogManage.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                ...
                <td class="t1" style="width: 12%; height: 29px; text-align: center">
                    操作单位：</td>
                <td class="t2" style="width: 40%; height: 29px; text-align: left">
            ...
            <tr>
                ...
                <td class="t4" style="height: 29px; text-align: center;" colspan="2">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查找日志" Width="145px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="删除日志" Width="107px" /></td>
            </tr>
        </table>
        <br />
