...
{
    public partial class ziyuan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (HttpContext.Current.Session["AccountID"] != null)
                {
                    ...
                    DataSet ds = CommClass.GetDataSet("select * from cw_rescard  order by cardno desc");
                    if (ds.Tables[0].Rows.Count >0)
                    {
                        this.CheckBoxList1.DataSource = ds;
                        this.CheckBoxList1.DataTextField = "resname";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"]!=null)
            {
                ...
                string strsql = "update cw_ztbxm set xmzyid='"+strzyid+"',xmzylb='2' where id='"+strid+"'";
