<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadPic.aspx.cs" Inherits="SanZi.Web.uploadPic" %>
        ...
        <tr style="background: #ffffff;">
            <td colspan="2">
                <!--
                    ...
                    -->
                <asp:Button ID="btnCheckPic" runat="server" Text="检查票据" OnClick="btnCheckPic_Click" />
