<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="SanZi.Web.tousu.Show" Title="显示页" %>
    ...
    <div align="center">
          <table style="width:600px;border:1px solid #000800;margin-top:5px;background:#000800;" cellspacing="1" cellpadding="3" >
            <tr style="background:#ffffff;">
                <td colspan="2" class="tableTitle2">查看投诉</td>
            </tr>
            <tr style="background:#ffffff;">
