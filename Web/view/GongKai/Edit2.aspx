<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit2.aspx.cs" Inherits="SanZi.Web.GongKai.Edit2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>修改村务公开信息</title>
...
<script type="text/javascript" language="javascript"> 
    function check_input()  {
        ...
        try
        {
            ...
            {
                alert("保存成功！");
                location.href = "Manage2.aspx?lbid=<%=Request.QueryString["lbid"] %>";
            }
...
function docOpen() {
	...
	flag = document.all.WebOffice1.LoadOriginalFile(myform.DocFilePath.value,"doc");
	if( 0 == flag){
         ...
         <table style="width:850px;border:1px solid #000800;margin-top:5px;background:#000800;" cellspacing="1" cellpadding="3" >
            ...
            <tr style="background:#ffffff;">
                <td class="tableContent" colspan="2">
                    <input type="hidden" name="hidDocID" id="hidDocID" value=""  runat="server"/>
            ...
            <tr style="background:#ffffff;height:30px;">
                <td colspan="2">
                        <input id="btnSave" type="button" value="  修改  " onclick="return check_input();"/>
                </td>
            </tr>
         </table>
