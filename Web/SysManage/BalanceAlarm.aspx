<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_BalanceAlarm" Codebehind="BalanceAlarm.aspx.cs" %>
...
{
    //var returnV=window.showModalDialog("../AccountCollect/SelAllSubject.aspx?slist=101|541&g="+(new Date()).getTime(),"","dialogWidth=402px;dialogHeight:387px;center=yes;");
    var returnV = window.showModalDialog("../AccountCollect/SelAllSubject.aspx?g=" + (new Date()).getTime(), "", "dialogWidth=402px;dialogHeight:387px;center=yes;");
...
function OpenMonitor(id,flag)
{
    switch(flag)
    {
        case "0":
        case "3":
            window.showModalDialog("../AccountCollect/IndexMonitorShow0.aspx?id="+id+"&g="+(new Date()).getTime(),"","dialogWidth=770px;dialogHeight:550px;center=yes;");
            break;
        case "1":
            window.showModalDialog("../AccountCollect/IndexMonitorShow1.aspx?id="+id+"&g="+(new Date()).getTime(),"","dialogWidth=770px;dialogHeight:600px;center=yes;");
            break;
        case "2":
            window.showModalDialog("../AccountCollect/IndexMonitorShow2.aspx?id="+id+"&g="+(new Date()).getTime(),"","dialogWidth=770px;dialogHeight:600px;center=yes;");
            break;
     }
     return false;
}
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">限额报警参数设置</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t1" style="width: 12%; height: 33px; text-align: right; font-size:10pt">
                    设置科目：</td>
                <td class="t1" style="width: 50%; height: 33px;">
                    &nbsp;<asp:TextBox ID="IndexSubject" runat="server" Width="200px" MaxLength="50" BackColor="#E0E0E0" BorderWidth="1px"></asp:TextBox></td>
                <td class="t1" style="width: 12%; font-size: 10pt; width: 10%; height: 33px; text-align: right">
                    报警限额：</td>
                <td class="t2" style="width: 26%; height: 33px;">
                    &nbsp;<asp:TextBox ID="IndexValue" runat="server" Width="120px" MaxLength="50" BorderWidth="1px">0</asp:TextBox></td>
            </tr>
            <tr>
                <td class="t3" style="text-align: right; height: 33px; font-size:10pt">
                    报警类型：</td>
                <td class="t3" style="height: 33px; text-align: left" colspan="2">
                    <asp:RadioButtonList ID="IndexType" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="0" Selected="True">借方单笔发生额</asp:ListItem>
                        <asp:ListItem Value="3">贷方单笔发生额</asp:ListItem>
                        <asp:ListItem Value="1">月累计发生额</asp:ListItem>
                        <asp:ListItem Value="2">年累计发生额</asp:ListItem>
                    </asp:RadioButtonList></td>
                <td class="t4" style="height: 33px; text-align: left">
                    &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="添加设置" Width="80px" /></td>
            </tr>
        </table>
        <br />
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="报警类型">
                    <EditItemTemplate>
                        <asp:DropDownList ID="IndexTypeEdit" runat="server" SelectedValue='<%# Bind("IndexType") %>'>
                            <asp:ListItem Value="0">借方单笔发生额</asp:ListItem>
                            <asp:ListItem Value="3">贷方单笔发生额</asp:ListItem>
                            <asp:ListItem Value="1">月累计发生额</asp:ListItem>
                            <asp:ListItem Value="2">年累计发生额</asp:ListItem>
                        </asp:DropDownList>
                ...
                <asp:BoundField DataField="IndexValue" HeaderText="报警限额" HtmlEncode="False" DataFormatString="{0:f}">
