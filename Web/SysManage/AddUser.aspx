<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_AddUser" Codebehind="AddUser.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">添加操作员</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                ...
                <td class="t2" colspan="3">
                    <asp:CheckBoxList ID="Accounts" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="634px">
                    </asp:CheckBoxList>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="t4" colspan="4" style="height: 37px; text-align: center">
                    ...
                    <input id="Button2" onclick="document.location.href='UserManage.aspx';" type="button" value="显示操作员列表" /></td>
            </tr>
        </table>
    </div>
