<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_BalanceReplyDo" Codebehind="BalanceReplyDo.aspx.cs" %>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">三资流程审批一览表</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="VoucherID" HeaderText="批复日期">
                    <ItemStyle Width="120px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="审核">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                    <ItemTemplate>
                        <asp:LinkButton ID="btnAudit" runat="server" CommandName='<%# Bind("id") %>' CommandArgument='<%# Bind("AccountID") %>' OnClick="btnAudit_Click">审核</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
