...
public partial class SysManage_CommDics : System.Web.UI.Page
{
    ...
    {
        DataTable dt = MainClass.GetDataTable("select paraname,paratype,paravalue from cw_syspara where paratype='" + ParaType.SelectedValue + "'");
        if (dt.Rows.Count == 0)
        {
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        MainClass.ExecuteSQL(string.Concat("update cw_syspara set ", "paravalue='", paraValue, "' ", "where paraname='", paraName, "'"));
        GridView1.EditIndex = -1;
        InitWebControl();
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        MainClass.ExecuteTransaction("delete from cw_syspara where paraname='" + btnDelete.CommandArgument + "'");
        InitWebControl();
    }
    ...
    {
        MainClass.ExecuteSQL(string.Concat("insert into cw_syspara(paraname,paratype,paravalue)values('CommPara",
            MainClass.GetRecordID("CW_SysPara"), "','", ParaType.SelectedValue, "','", ParaValue.Text, "')"));
        ParaValue.Text = "";
        ParaValue.Focus();
        InitWebControl();
    }
