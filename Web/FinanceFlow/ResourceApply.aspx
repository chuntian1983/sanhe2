<%@ Page Language="C#" AutoEventWireup="true" Inherits="FinanceFlow_ResourceApply" Codebehind="ResourceApply.aspx.cs" %>
...
{
   window.showModalDialog("../Contract/LeaseCardShow.aspx?ctype=1&id="+vid+"&g="+(new Date()).getTime(),"","dialogWidth=770px;dialogHeight=400px;center=yes;");
   return false;
}
function CreateContract(aid,rid)
{
   if(window.showModalDialog("../Contract/LeaseCard.aspx?ctype=1&rid="+rid+"&aid="+aid+"&g="+(new Date()).getTime(),"","dialogWidth=750px;dialogHeight:480px;center=yes;")!="000000")
   {
...
{
    var info=window.showModalDialog("SelectAsset.aspx?atype=2&g="+(new Date()).getTime(),"","dialogWidth=750px;dialogHeight:365px;center=yes;");
    if(info)
    {
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">资源发包请示</span></td>
            </tr>
        </table>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AssetModel" HeaderText="座落位置">
                    <ItemStyle Width="70px" HorizontalAlign="Center" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="LAmount" HeaderText="面积" HtmlEncode="False" DataFormatString="{0:f}">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="LYears" HeaderText="发包年限" HtmlEncode="False" DataFormatString="{0:f}">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="MyBasePrice" HeaderText="年单位均底价" HtmlEncode="False" DataFormatString="{0:f}">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="AssessBasePrice" HeaderText="评估均底价" HtmlEncode="False" DataFormatString="{0:f}" ReadOnly="true">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
