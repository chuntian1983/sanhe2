<%@ Page Language="C#" AutoEventWireup="true" Inherits="FinanceFlow_ResourceAssess" Codebehind="ResourceAssess.aspx.cs" %>
...
<body>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">资源发包评估</span></td>
            </tr>
        </table>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="AssetCardID" HeaderText="资源名称" ReadOnly="true">
                    <ItemStyle Width="100px" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="AssetModel" HeaderText="座落位置" ReadOnly="true">
                    <ItemStyle Width="70px" HorizontalAlign="Center" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="LAmount" HeaderText="面积" HtmlEncode="False" DataFormatString="{0:f}" ReadOnly="true">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="LYears" HeaderText="发包年限" HtmlEncode="False" DataFormatString="{0:f}" ReadOnly="true">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="MyBasePrice" HeaderText="年单位均底价" HtmlEncode="False" DataFormatString="{0:f}" ReadOnly="true">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
                <asp:BoundField DataField="AssessBasePrice" HeaderText="评估均底价" HtmlEncode="False" DataFormatString="{0:f}">
                    <ItemStyle Width="90px" HorizontalAlign="Right" />
                    <ControlStyle Width="95%" />
                </asp:BoundField>
