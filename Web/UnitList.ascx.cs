...
public partial class UnitList : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (!TreeView1.SelectedNode.Value.StartsWith("$") && TreeView1.SelectedNode.Parent != null)
            {
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        if (TreeView1.SelectedNode.Value.StartsWith("$"))
        {
            ...
            Session["TownID"] = TreeView1.SelectedNode.Parent.Value;
            Session["TownName"] = TreeView1.SelectedNode.Parent.Text;
        ...
        else
        {
            UT.Value = "0";
            UnitID.Value = "000000";
            Session["TownID"] = TreeView1.SelectedNode.Value;
            Session["TownName"] = TreeView1.SelectedNode.Text;
