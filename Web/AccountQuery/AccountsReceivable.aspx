<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_AccountsReceivable" Codebehind="AccountsReceivable.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span style="color:Blue; font-size: 20pt;">应 收 账 款 余 额 情 况</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
