<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_SubjectBalanceSGL" Codebehind="SubjectBalanceSGL.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px" class="Noprint">
            <tr>
                <td class="t1" style="width: 10%; text-align: right">查询日期：</td>
                ...
                <td class="t1" style="width: 30%; text-align: center">
