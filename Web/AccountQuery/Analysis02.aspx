<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_Analysis02" Codebehind="Analysis02.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="color:Blue; font-size: 20pt;" runat="server">福利费收支分析表</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
