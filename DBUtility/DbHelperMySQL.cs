...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static bool Exists1(string strSql)
        {
        ...
        public static int ExecuteSql1(string SQLString)
        {
            ...
            {
                using (MySqlCommand cmd = new MySqlCommand("set names gb2312;" + SQLString, connection))
                {
                    try
                    {
                        connection.Open();
        ...
        /// 获取账套名称
        /// </summary>
        public static string GetFieldFromID(string ID, string CountName, string TableName)
        {
            string AccountID = "000000";
            String strSql = "";
            if (ID != null && ID != "")
            {
              strSql = "select " + CountName + " from " + TableName + " where ID=" + ID + "";
              //strSql = "select	AccountName from cw_account  where  id = '100001'";
            }
            else
            {
                strSql = "select " + CountName + "from " + TableName + " where ID='000000'";
            }

            DataSet ds = DbHelperMySQL.Query1(strSql);
            if (ds.Tables[0].Rows.Count > 0)
            {
                AccountID = ds.Tables[0].Rows[0]["AccountName"].ToString();
            }
            return AccountID;
        }
        ...
        public static object ExecuteSqlGet(string SQLString, string content)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand("set names gb2312;" + SQLString, connection);
                MySql.Data.MySqlClient.MySqlParameter myParameter = new MySql.Data.MySqlClient.MySqlParameter("@content", SqlDbType.NText);
                myParameter.Value = content;
                cmd.Parameters.Add(myParameter);
                try
        ...
        public static MySqlDataReader ExecuteReader(string strSQL)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("set names gb2312;" + strSQL, connection);
            try
            {
                connection.Open();
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql1(string SQLString, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString1))
            {
                using (MySqlCommand cmd = new MySqlCommand())
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query1(string SQLString, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString1))
            {
                MySqlCommand cmd = new MySqlCommand();
