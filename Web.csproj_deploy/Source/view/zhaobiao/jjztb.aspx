<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jjztb.aspx.cs" Inherits="SanZi.Web.zhaobiao.jjztb" %>
...
<body>
    ...
    <td align="left" style="width:35%; border-bottom:solid 1px #000800; border-left:solid 1px #000800">
        <asp:TextBox ID="tbcyry" runat="server" Height="100px" TextMode="MultiLine"></asp:TextBox>
        </td> 
