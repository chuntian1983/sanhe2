<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cyss.aspx.cs" Inherits="SanZi.Web.zhaobiao.cyss" %>
...
<body>
    ...
    <div align="center">
        ...
        <tr><td width="40px"></td><td height="60px">
            <asp:TextBox ID="tbcun" runat="server" Width="70px"></asp:TextBox>村<asp:TextBox ID="tbyss"
        ...
        <td align="right" height="50px">
            ...
            年<asp:TextBox ID="month" runat="server" Width="40px"></asp:TextBox>
            月<asp:TextBox ID="day" runat="server" Width="40px"></asp:TextBox>
            日</td><td width="40px"></td></tr>
