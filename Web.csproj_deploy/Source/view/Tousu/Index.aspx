<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SanZi.Web.tousu.tsgl" %>
        ...
        <td> 
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DeptName" HeaderText="投诉部门" >
                    <ItemStyle Width="20%" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Content" HeaderText="投诉内容" >
                    <ItemStyle Width="25%" />
                    </asp:BoundField>
                    <asp:BoundField DataField="SubIP" HeaderText="投诉人IP" >
                    <ItemStyle Width="20%" />
                    </asp:BoundField>
