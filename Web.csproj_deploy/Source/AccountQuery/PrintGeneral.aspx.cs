...
public partial class AccountQuery_PrintGeneral : System.Web.UI.Page
{
    public StringBuilder AllVoucher = new StringBuilder();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            InitWebControl();
            //写入操作日志
            CommClass.WriteCTL_Log("100014", "账簿查询：总账连续打印");
            //--
        }
    }
    protected void InitWebControl()
    {
        string QueryString = "$ParentNo='000'";
        ...
        if (SubjectNoS.Text.Length > 0)
        {
            ...
            {
                QueryString += "$SubjectNo between '" + SubjectNoS.Text + "' and '" + SubjectNoE.Text + "'";
            }
            else
            {
                QueryString += "$SubjectNo='" + SubjectNoS.Text + "'";
            }
        }
