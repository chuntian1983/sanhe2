<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_CommReportgk" Codebehind="CommReportgk.aspx.cs" %>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr >
                ...
                <asp:Button ID="SaveSheet" runat="server" Text="保存设置" Visible=false OnClick="SaveSheet_Click" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="GetTemplate" runat="server" Text="取用模板库" Visible=false OnClick="GetTemplate_Click" />&nbsp;&nbsp;&nbsp;
                <input id="Button4" onclick="window.open('../PrintWeb.html','','');" runat=server visible=false     type="button" value="打印报表" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="OutputDataToExcel" Visible=false runat="server" OnClick="OutputDataToExcel_Click" Text="导出数据至Excel" Width="120px" /></td>
        </tr>
        </table>
