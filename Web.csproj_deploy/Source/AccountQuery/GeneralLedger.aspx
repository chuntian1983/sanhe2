<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_GeneralLedger" Codebehind="GeneralLedger.aspx.cs" %>
...
function SelSubject()
{
    var returnV=window.showModalDialog("../AccountInit/SelAllSubject.aspx?t=2&g="+(new Date()).getTime(),"","dialogWidth=402px;dialogHeight:387px;center=yes;");
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="5" style="height: 31px; text-align: center">
                    ...
                    &nbsp;&nbsp;
                    <input id="Button4" onclick="window.open('../PrintWeb.html','','');" style="width:180px" type="button" value="打印报表" />
                    &nbsp;&nbsp;
                    <input id="Button2" onclick="location.href='PrintGeneral.aspx';" style="width:180px" type="button" value="连续打印" />
                    &nbsp;&nbsp;
