<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_PrintDetail" Codebehind="PrintDetail.aspx.cs" %>
...
<body style="font-size: 10pt" onpaste="return false">
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span style="font-size: 18pt; font-family: 隶书">明细账连续打印输出</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="5" style="height: 31px; text-align: center">
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <input id="Button1" onclick="location.href='DetailAccount.aspx';" style="width:180px" type="button" value="普通打印" />
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <!--NoPrintEnd-->
        <asp:HiddenField ID="GridViewWidth" runat="server" Value="1004" />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
