<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountQuery_Analysis04" Codebehind="Analysis04.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t3" style="width: 10%; text-align: center; height:30px">
                    查询日期：</td>
                <td class="t3" style="width: 40%; text-align: center;">
     ...
     <asp:HiddenField ID="ReportTitle" runat="server" />
