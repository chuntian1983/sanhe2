<%@ Page Language="C#" AutoEventWireup="true" Inherits="BillManage_CheckEdit" Codebehind="CheckEdit.aspx.cs" %>
...
function CheckSubmit()
{
    ...
    if ($("BillNoPre").value != "") {
        return confirm("注意：将同步更新{发票前缀为：" + $("BillNoPre").value + "}并未申领的所有支票！\n\n是否继续保存？");
    }
    return true;
}
function OnWinClose()
            ...
            <table cellpadding="0" cellspacing="0" style="width: 550px">
                <tr>
                    <td style="height: 35px; text-align: center">
                        <span style="font-size: 16pt; font-family: 隶书">支票修改</span>&nbsp;</td>
                </tr>
            </table>
        </div>
        <table id="EditorTable" cellpadding="0" cellspacing="0" style="width: 550px" runat="server">
            ...
            <tr>
                <td class="t1" style="height:29px; text-align: right">
                    支票号码：</td>
                <td class="t2">
                    <asp:TextBox ID="BillNo" runat="server" BorderWidth="1px" Width="120px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="t1" style="height:29px; text-align: right">
                    支票前缀：</td>
                <td class="t2">
                    <asp:TextBox ID="BillNoPre" runat="server" BorderWidth="1px" Width="120px"></asp:TextBox>（非空时起作用）</td>
            </tr>
            <tr>
