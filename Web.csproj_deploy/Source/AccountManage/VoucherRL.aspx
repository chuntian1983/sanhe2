<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountManage_VoucherRL" Codebehind="VoucherRL.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">凭证记账 -- 列表</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        ...
        <br /><table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                ...
                <td class="t4" style="width: 35%; height: 31px; text-align: center;">
                    <input id="Button2" type="button" value="单张凭证显示" onclick="location.href='VoucherRM.aspx';" />
                    &nbsp; &nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="IsRecord" runat="server" CommandName='<%# Bind("id") %>' CommandArgument='<%# Bind("IsRecord") %>' OnClick="IsAuditing_Click">记账</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
