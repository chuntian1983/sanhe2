...
public partial class FinanceFlow_AssessList : System.Web.UI.Page
{
    ...
    protected void btnAssess_Click(object sender, EventArgs e)
    {
        ...
        {
            case "1":
                Response.Redirect("AssetAssess.aspx?id=" + btn.CommandArgument);
                break;
            case "2":
                Response.Redirect("ResourceAssess.aspx?id=" + btn.CommandArgument);
                break;
        }
    }
