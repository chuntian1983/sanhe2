<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="AccountCollect_MonitorResource" Codebehind="MonitorResource.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="color:green; font-size: 16pt;" runat="server">资源监管</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t1" style="width: 10%; height: 30px; text-align: center">
                    监控单位：</td>
                <td class="t1" colspan="2" style="width: 25%; text-align: left">
                    &nbsp;&nbsp;
                ...
                <td class="t1" style="width: 13%; text-align: center">
                    &nbsp;数量或面积：</td>
                <td class="t2" style="width: 22%; text-align: center">
                    <asp:TextBox ID="IndexValue" runat="server" Width="120px">0</asp:TextBox></td>
            </tr>
            <tr>
