<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="Contract_TurnResource" Codebehind="TurnResource.aspx.cs" %>
...
{
    window.showModalDialog("LeaseCard.aspx?ctype=1&rid="+rid+"&g="+(new Date()).getTime(),btn,"dialogWidth=750px;dialogHeight:480px;center=yes;");
    return false;
}
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">资源流转</span>&nbsp;</td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="经营方式" DataField="BookType">
                    <ItemStyle Width="120px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="resamount" HeaderText="数量或面积" DataFormatString="{0:f}" HtmlEncode="False">
                    <ItemStyle Width="80px" HorizontalAlign="Right" />
                </asp:BoundField>
                <asp:BoundField DataField="hasamount" HeaderText="已流转" DataFormatString="{0:f}" HtmlEncode="False">
                    <ItemStyle Width="80px" HorizontalAlign="Right" />
                </asp:BoundField>
                ...
                <asp:TemplateField HeaderText="流转">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:HiddenField ID="ResAmount" Value='<%# Bind("ResAmount") %>' runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <PagerTemplate>
