<%@ Page Language="C#" AutoEventWireup="true" Inherits="Contract_DueNoticePay" Codebehind="DueNoticePay.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="margin:5px; font-size:12pt; width: 615px; height: 315px;">
            ...
            <tr>
                <td style="text-align:left; vertical-align:top; line-height:35px; height:auto;">
                    ...
                    付款到期，请在接到通知后，及时到三资代理服务中心交本期租金：
                    <asp:Label ID="PayMoney" runat="server" CssClass="textCenter" Width="145px"></asp:Label>元。
                </td>
            </tr>
            <tr>
