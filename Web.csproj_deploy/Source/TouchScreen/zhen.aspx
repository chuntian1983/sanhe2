<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhen.aspx.cs" Inherits="yuxi.zhen" %>
...
<body style="margin:0px">
	...
	<tr>
        ...
        <div>
                        ...
                        <tr>
                            ...
                            <div style="padding: 8px 50px 8px 50px; background-position: center center; background-image:url(images/0001.jpg); float: none; font-family: 宋体, Arial, Helvetica, sans-serif; font-size:16px; vertical-align: middle; text-align: center; color: #000000;">
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="view" 
                                    CommandArgument='<%#Eval("id") %>' Font-Underline="False"><%#Eval("name").ToString().Length>15?Eval("name").ToString().Substring(0,14):Eval("name").ToString() %></asp:LinkButton></div>
                               </td>
            ...
            ShowPageIndexBox="Never" ShowCustomInfoSection="Left" PageSize="21" 
                CustomInfoHTML="页码 %CurrentPageIndex% of %PageCount%">
