<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_QEditUser" Codebehind="QEditUser.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">编辑村级查询站点信息</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="4" style="height: 37px; text-align: center">
                    ...
                    <input id="Button2" type="button" value="显示查询站点列表" onclick="document.location.href='QUserManage.aspx';" /></td>
            </tr>
        </table>
