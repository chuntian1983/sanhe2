<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_BalanceAlarmDo" Codebehind="BalanceAlarmDo.aspx.cs" %>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">超额凭证一览表</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DoState" HeaderText="审核状态">
                    <ItemStyle Width="70px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="BookTime" HeaderText="提交时间" HtmlEncode="False" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}">
                    <ItemStyle Width="120px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="审核">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                    <ItemTemplate>
                        <asp:LinkButton ID="btnAudit" runat="server" CommandName='<%# Bind("id") %>' CommandArgument='<%# Bind("DoState") %>' OnClick="btnAudit_Click">审核</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="查看">
                    <ItemStyle HorizontalAlign="Center" Width="70px" />
                    <ItemTemplate>
                        <asp:LinkButton ID="btnMonitor" runat="server" CommandArgument='<%# Bind("AccountID") %>' CommandName='<%# Bind("VoucherID") %>'>查看凭证</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="删除">
                    <ItemStyle HorizontalAlign="Center" Width="50px" />
                    <ItemTemplate>
                        <asp:LinkButton ID="btnDelete" runat="server" CommandName='<%# Bind("id") %>' CommandArgument='<%# Bind("AccountID") %>' OnClick="btnDelete_Click">删除</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
