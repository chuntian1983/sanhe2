...
public partial class SysManage_BidUserManage : System.Web.UI.Page
{
    ...
    {
        string QueryString = "$username<>'FinancailDefaultAdmin'$unitid='X00001'$Powers='" + UserInfo.UnitID + "'";
    ...
    {
        LinkButton btn = (LinkButton)sender;
        Response.Redirect("BidEditUser.aspx?id=" + btn.CommandArgument);
    }
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            e.Row.Cells[1].Text = ValidateClass.ReadXMLNodeText("FinancialDB/CUnits[ID='" + e.Row.Cells[1].Text + "']", "UnitName");
