function showitem(id,name)
{
    if (id.html) {
        ...
        return ("<span><a href='" + id.a + "' target='" + id.target + "'>" + name + "</a></span><br>");
    }
    else if (id == "###") {
        return name;
    }
    else {
        return ("<span><a href='" + id + "' target=mFrame>" + name + "</a></span><br>");
    }
}
  ...
  if (number!=i && outlooksmoothstat==0){
    if (number!=-1)
    {
      if (i==-1){
        ...
        document.all("outlooktitle"+i).style.color="#990000";
      ...
      document.all("outlooktitle"+number).style.color="#990000";
...
function getOutLine()
{
  ...
  for (i=0;i<(outlookbar.titlelist.length);i++)
  {
    ...
    if (i!=outlookbar.opentitle) 
      outline+=" nowrap align=center style='cursor:hand;background-color:"+outlookbar.maincolor+";color:#000000;height:23;border:1 none navy' ";
    else
      outline+=" nowrap align=center style='cursor:hand;background-color:"+outlookbar.maincolor+";color:#000000;height:23;border:1 none white' ";
    ...
    outline+="'><div name=outlookdivin"+i+" id=outlookdivin"+i+" style='overflow-y:scroll;width:100%;height:100%'>";
...
{
  var outline;
  outline="<div id=outLookBarDiv name=outLookBarDiv style='width=100%;height:500'>"
