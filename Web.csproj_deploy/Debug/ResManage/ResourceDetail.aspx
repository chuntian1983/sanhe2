<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="ResManage_ResourceDetail" Codebehind="ResourceDetail.aspx.cs" %>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 1004px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">资源明细表</span>&nbsp;</td>
            </tr>
        </table>
        <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="BookType" HeaderText="经营方式">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="DeptName" HeaderText="从属部门">
                ...
                <asp:BoundField DataField="Locality" HeaderText="座落">
                    <ItemStyle Width="333px" />
                </asp:BoundField>
            </Columns>
            <PagerTemplate>
