<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountManage_VoucherRM" Codebehind="VoucherRM.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">凭证记账 -- 单张</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                ...
                <td class="t2" style="width: 33%; text-align: center;">
                    ...
                    <asp:Button ID="AuditQVoucher" runat="server" Height="25px" OnClick="AuditQVoucher_Click" Text="按此条件记账凭证" Width="137px" /></td>
            </tr>
            <tr>
                <td class="t4" style="height: 32px; text-align: center" colspan="5">
                    ...
                    <input id="Button4" type="button" value="查看凭证列表" style="height:25px; width:97px" onclick="location.href='VoucherRL.aspx';" />&nbsp;&nbsp;
                    <asp:Button ID="BackControl" runat="server" Text="反记账" Height="25px" Width="72px" OnClick="BackControl_Click" />&nbsp;&nbsp;
                    <asp:Button ID="AuditVoucher" runat="server" OnClick="AuditVoucher_Click" Text="记账当前凭证" Height="25px" Width="90px" />&nbsp;&nbsp;
                    <asp:Button ID="AuditAllVoucher" runat="server" OnClick="AuditAllVoucher_Click" Text="批量记账所有凭证" Height="25px" Width="137px" /></td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
