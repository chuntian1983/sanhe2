<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" Inherits="AccountInit_SystemSubject" Codebehind="SystemSubject.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="4" style="height: 35px; text-align: center">
                    <asp:Button ID="AddSubject" runat="server" Height="26px" Text="添加科目" Width="250px" OnClick="AddSubject_Click" />
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="GoParent" runat="server" Height="26px" Text="返回上级科目" Width="250px" OnClick="GoParent_Click" CommandArgument="000" />
                    <%--&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="OutSubjectData" runat="server" Text="导出科目表" OnClick="OutSubjectData_Click" />--%></td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td id="M0" class="t3" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx';" runat="server">
                    全部</td>
                <td id="M1" class="t3" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx?stype=1';" runat="server">
                    资产类</td>
                <td id="M2" class="t3" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx?stype=2';" runat="server">
                    负债类</td>
                <td id="M3" class="t3" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx?stype=3';" runat="server">
                    权益类</td>
                <td id="M4" class="t3" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx?stype=4';" runat="server">
                    成本类</td>
                <td id="M5" class="t4" style="height: 22px; text-align: center; width:16%; cursor:hand" onclick="location.href='SystemSubject.aspx?stype=5';" runat="server">
                    损益类</td>
            </tr>
        </table>
        <br />
