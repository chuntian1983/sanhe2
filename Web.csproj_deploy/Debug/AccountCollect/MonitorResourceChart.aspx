<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountCollect_MonitorResourceChart" Codebehind="MonitorResourceChart.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="font-size: 16pt; font-family: 隶书" runat="server">资源统计分析图</span>&nbsp;</td>
            </tr>
        </table>
        <br />
