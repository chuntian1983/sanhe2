<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountCollect_MonitorChart" Codebehind="MonitorChart.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="font-size: 16pt; font-family: 隶书" runat="server">图表统计</span>&nbsp;</td>
            </tr>
        </table>
        <br />
        <table id="DoOverLay" cellpadding="0" cellspacing="0" style="width: 750px;">
            ...
            <tr>
                <td class="t2" rowspan="6" valign="top" style="width: 35%; height:190px">
            ...
            <tr>
                <td class="t1" style="background-color: #f6f6f6; text-align: right">
                    统计类型：</td>
                <td class="t1">
                    <asp:RadioButtonList ID="SumType" runat="server" RepeatDirection="Horizontal" Width="170px">
                        <asp:ListItem Selected="True" Value="0">按项统计</asp:ListItem>
                        <asp:ListItem Value="1">按月统计</asp:ListItem>
                    </asp:RadioButtonList></td>
                <td class="t1" style="background-color: #f6f6f6; text-align: right">
                    同期对比：</td>
                <td class="t2">
                    <asp:RadioButtonList ID="CompareType" runat="server" RepeatDirection="Horizontal" Width="160px">
                        <asp:ListItem Selected="True" Value="0">禁用</asp:ListItem>
                        <asp:ListItem Value="1">去年</asp:ListItem>
                        <asp:ListItem Value="2">明年</asp:ListItem>
                    </asp:RadioButtonList></td>
            </tr>
            <tr>
                ...
                <td class="t2" colspan="3">
                    &nbsp;<asp:TextBox ID="StatisticExpr" runat="server" Width="401px" BorderWidth="1px" Height="30px" TextMode="MultiLine" ForeColor="blue"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="t1" style="text-align: right; background-color: #f6f6f6">
                    排序方式：</td>
                ...
                <td class="t2">
                    <asp:CheckBoxList ID="ValueType" runat="server" RepeatDirection="Horizontal" Width="160px">
                        ...
                        <asp:ListItem Value="1" Selected="True">正值</asp:ListItem>
                        <asp:ListItem Value="2">负值</asp:ListItem>
                    </asp:CheckBoxList></td>
            </tr>
            <tr>
                <td class="t1" style="text-align: right; background-color: #f6f6f6">
