<%@ Page Language="C#" AutoEventWireup="true" Inherits="AccountCollect_IndexMonitorShow2" Codebehind="IndexMonitorShow2.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="ReportTitle" style="color:green; font-size: 16pt;" runat="server">指标监控 —— 年累计发生额</span></td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
