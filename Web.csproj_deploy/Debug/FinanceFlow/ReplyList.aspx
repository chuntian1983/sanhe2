<%@ Page Language="C#" AutoEventWireup="true" Inherits="FinanceFlow_ReplyList" Codebehind="ReplyList.aspx.cs" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="否决流程" ShowHeader="False">
                    <ItemTemplate>
                        <asp:LinkButton ID="btnVeto" runat="server" CommandArgument='<%# Bind("id") %>' OnClick="btnVeto_Click">否决</asp:LinkButton>
                    </ItemTemplate>
