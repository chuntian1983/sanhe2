<%@ Page Language="C#" AutoEventWireup="true" Inherits="BidManage_BidList" Codebehind="BidList.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span id="PageTitle" runat="server" style="font-size: 16pt; font-family: 隶书">标题</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" style="height: 35px; text-align: center" colspan="4">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="Button2" type="button" style="width:108px" value="- 新增 -" onclick="location.href='BidEdit.aspx?step=<%=Request.QueryString["step"] %>'" />
