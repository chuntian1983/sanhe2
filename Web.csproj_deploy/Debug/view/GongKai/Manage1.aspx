...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage1.aspx.cs" Inherits="SanZi.Web.GongKai.Manage1" %>
     ...
     <table style="width:100%;text-align:left;margin-top:5px;background:#000800;" cellspacing="1" cellpadding="3" >
        ...
        <tr style="background:#ffffff;">
            <td class="tableContent">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input id="Button1" type="button" value="添加" onclick="location.href='Add.aspx'" />
            </td>
        </tr>
        <tr style="background:#ffffff;">
            <td class="tableContent">
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <tr style="background-color:#FAF3DC">
                        ...
                        <td><a href="Show.aspx?dt=xls&p=1&id=<%#DataBinder.Eval(Container.DataItem, "ID")%>&lbid=<%#Eval("subuid") %>" title="查看村务公开详细信息"><%#DataBinder.Eval(Container.DataItem, "Title")%></a></td>
                        <td><a href="Edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "ID")%>&lbid=<%#Eval("subuid") %>">修改</a>  <a href="Manage1.aspx?act=del&id=<%#DataBinder.Eval(Container.DataItem, "ID")%>" onclick="return confirm('确定要删除此村务公开表吗？');">删除</a> </td>
                    </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                    </table>
