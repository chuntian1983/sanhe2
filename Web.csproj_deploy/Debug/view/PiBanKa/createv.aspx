<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createv.aspx.cs" Inherits="SanZi.Web.view.PiBanKa.createv" %>
...
<script type="text/javascript">
    ...
    function check() {
        var s0 = eval($("m0").value);
        var s1 = eval($("m1").value);
        if (s1 > s0) {
            alert("支出金额不能大于可用金额！");
            return false;
        }
...
<body>
    ...
    <div>
        <asp:HiddenField ID="addons" runat="server" />
        <table cellpadding="0" cellspacing="0" style="width: 400px">
            ...
            <tr>
                ...
                <td class="t1" style="width: 30%; height: 25px;">
                    <asp:TextBox ID="m0" runat="server" Width="110px"></asp:TextBox></td>
                <td class="t1" style="width: 20%; height: 25px; text-align: center">
                    支付金额：</td>
                <td class="t2" style="width: 30%; height: 25px;">
                    <asp:TextBox ID="m1" runat="server" Width="110px"></asp:TextBox></td>
            </tr>
