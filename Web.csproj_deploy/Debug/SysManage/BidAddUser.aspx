<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_BidAddUser" Codebehind="BidAddUser.aspx.cs" %>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">添加招投标管理用户</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            ...
            <tr>
                <td class="t4" colspan="4" style="height: 37px; text-align: center">
                    ...
                    <input id="Button2" onclick="document.location.href='BidUserManage.aspx';" type="button" value="显示用户列表" /></td>
            </tr>
        </table>
    </div>
