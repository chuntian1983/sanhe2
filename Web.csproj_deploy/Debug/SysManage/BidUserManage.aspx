<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysManage_BidUserManage" Codebehind="BidUserManage.aspx.cs" %>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t4" style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">招投标用户管理</span>&nbsp;
                </td>
            </tr>
        </table>
        <br />
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td class="t3" style="width: 20%; height: 29px; text-align: center; background:#f6f6f6">
                    <input id="Button3" type="button" value="添加用户" onclick="location.href='BidAddUser.aspx';" style="width: 108px" /></td>
                ...
                <td class="t4" style="width: 20%; height: 29px; text-align: center;">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查找用户" Width="108px" /></td>
            </tr>
        </table>
        <br />
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="accountid" HeaderText="从属乡镇">
