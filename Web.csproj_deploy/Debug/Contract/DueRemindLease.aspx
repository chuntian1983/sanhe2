<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="Contract_DueRemindLease" Codebehind="DueRemindLease.aspx.cs" %>
...
function PrintDueCard(v)
{
    window.showModalDialog("DueNoticeLease.aspx?id="+v+"&g="+(new Date()).getTime(),"","dialogWidth=650px;dialogHeight:400px;center=yes;");
    return false;
}
</script>
</head>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 750px">
            <tr>
                <td style="height: 28px; text-align: center">
                    <span style="font-size: 16pt; font-family: 隶书">合同到期一览表</span>&nbsp;</td>
            </tr>
        </table>
        <br />
        <!--NoPrintStart-->
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="YearRental" DataFormatString="{0:f}" HeaderText="租价（元/年）"
                    HtmlEncode="False">
                ...
                <asp:TemplateField HeaderText="到期通知">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="btnPrint" runat="server" CommandName='<%# Bind("id") %>'>打印</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <PagerTemplate>
